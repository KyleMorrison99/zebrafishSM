...
fig6 <- bd %>%
  ...
  geom_bar(stat = "identity", fill = "black", color = "white", position = position_dodge(0.9)) +
  geom_text(aes(label = n), position = position_stack(vjust = 0.5), color = "white", fontface = "bold", size = 3) +
  labs(title = "Total Number of Pesticides by Behavioural Class",
       x = "Count",
       y = "Behavioural Class") +
  theme_classic()
fig6
...
fig6 <- bd %>%
  ...
  geom_bar(stat = "identity", fill = "black", color = "white", position = position_dodge(0.9)) +
  geom_text(aes(label = n), position = position_stack(vjust = 0.5), color = "white", fontface = "bold", size = 3) +
  labs(title = "Total Number of Pesticides by Behavioural Activity",
       x = "Behavioural Activity",
       y = "Count") +
  theme_classic() +
  coord_flip()
...
fig7 <- bd %>%
  ...
  geom_bar(stat = "identity", fill = "black", color = "white", position = position_dodge(0.9)) +
  geom_text(aes(label = n), position = position_stack(vjust = 0.5), color = "white", fontface = "bold", size = 3) +
  labs(title = "Total Number of Pesticides by Behavioural Aggression",
       x = "Behavioural Aggression",
       y = "Count") +
  theme_classic() +
  coord_flip()
