...
fig3a <-  ggplot(total_pesticide_count, aes(x = n, y = reorder(pesticide_investigated, n))) +
...
fig3b <- ggplot(total_target_class_count, aes(x = n, y = reorder(pesticide_target_class, n))) +
 ...
 geom_text(data = target_class_pct, aes(label = paste0(round(percentage), "%")), 
  ...
  # Customize the appearance of the plot
  labs(x = "Count", y = "Pesticide Target Class") +
  theme_minimal() +
  theme(panel.grid.major.y = element_blank(),
    axis.line.y = element_blank(),
    axis.ticks.y = element_blank(),
...
# Calculate target class count as a percentage 
 ...
 fig3c <-  ggplot(total_chemical_class_count, aes(x = n, y = reorder(pesticide_chemical_class, n))) +
 ...
 geom_text(data = chemical_class_pct, aes(label = paste0(round(percentage), "%")), 
  ...
  # Customize the appearance of the plot
  labs(x = "Count", y = "Pesticide Chemical Class") +
  theme_minimal() +
  theme(panel.grid.major.y = element_blank(),
    axis.line.y = element_blank(),
    axis.ticks.y = element_blank(),
...
figs3 <- ggplot(route_pct, aes(x = reorder(route, percentage), y = percentage)) +
  ...
  # Flip the x and y axes and set the y-axis limits to 0-100
  coord_flip() + 
  ylim(0, 100)
