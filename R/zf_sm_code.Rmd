...
#colnames(NetMatrix_country) - change to title case:
colnames(NetMatrix_country) <- str_to_title(colnames(NetMatrix_country))
#rownames(NetMatrix_country) - change to title case:
...
colnames(NetMatrix_country)[7] <- "Newzealand" 
rownames(NetMatrix_country)[7] <- "Newzealand"
circos.clear()
...
fig12<- chordDiagram(NetMatrix_country, annotationTrack = "grid", preAllocateTracks = 1, grid.col = my.cols2)
