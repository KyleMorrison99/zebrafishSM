...
fig3
# ggsave(here("figures", "fig3_pesticide_count_combined.pdf"), width = 20, height = 12, units = "cm", scale = 2, dpi = 800)
...
## Figure 5b – Plot showing the distribuion of durations of pesticide exposure used in each study (filtered for waterborne exposure)
```{r, fig.width=8, fig.height=5}
pdo_duration <- pdo %>% 
...
## Figure 5d - Plot showing the distribution of sample sizes  used in pesticide exposure studies per group (if multiple exposure groups we calculated mean sample size per study)
```{r, fig.width=8, fig.height=5}
