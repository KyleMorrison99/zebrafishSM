...
- Objective 3.	To assess the research outputs of different countries and investigate the level of collaboration between authors amongst different countries. 
...
## fig 2j - comparison to lowest and highest dosages of waterbourne exposure to chlopyrifo
```{r}
...
## fig3g - total number of studies investigating each behavioural assay of Anxiety or Boldness behaviour
```{r}
fig3g <- bd %>%
...
```{r}
fig4.1 <- (fig4a / fig4b)  + plot_annotation(tag_levels = "A")
fig4.2 <- (fig4c  / fig4d) + plot_annotation(tag_levels = "A")
fig4.1
fig4.2
```
...
## fig 5d - author collaboration network - this is now done of vosviewer
```{r}
...
## fig 5h continent collaboration 
```{r}
