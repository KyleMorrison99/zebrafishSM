...
## fig4a - total lifestage of behaviour
``````{r, fig.width=8, fig.height=5}
...
fig4a <- ggplot(life_stage_pct, aes(x = reorder(life_stage_behaviour, percentage), y = percentage)) +
...
fig4a
# ggsave(here("figures", "fig4a_life_stage_behaviour.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig4a_life_stage_behaviour.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)

```

## fig4b - total lifestage of exposure 
```{r, fig.width=8, fig.height=5}
# Calculate total count for each category
...
fig4c <- ggplot(sex_pct, aes(x = reorder(sex, percentage), y = percentage)) +
...
fig4c
 # ggsave(here("figures", "fig4c_total_sex_exposed.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
 # ggsave(here("figures", "fig4c_total_sex_exposed.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
...
fig4
 ...
 #  ggsave(here("figures", "fig3_zebrafish_characteristics.pdf"), width = 15, height = 15, units = "cm", scale = 2, dpi = 800)
 #  ggsave(here("figures", "fig4_zebrafish_characteristics.jpg"), width = 15, height = 15, units = "cm", scale = 2, dpi = 800)
```

## fig5a - total route of exposure
```{r, fig.width=8, fig.height=5}
...
fig5a <- ggplot(route_pct, aes(x = reorder(route, percentage), y = percentage)) +
...
fig5a
 # ggsave(here("figures", "fig5a_pesticide_route_count.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
 # ggsave(here("figures", "fig5a_pesticide_route_count.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
...
## fig5b - comparison of lowest and highest dosages in waterbourne exposure methods
```{r, fig.width=8, fig.height=5}
...
fig5b <- ggplot(pdo_waterbourne, aes(x = dosage_type, y = log(dosage_value))) +
...
fig5b
# ggsave(here("figures", "fig5b_pesticide_dosage.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig5b_pesticide_dosage.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)

```

## figs3 - comparison of lowest and highest dosages of waterbourne exposure to deltamethrin
```{r, fig.width=8, fig.height=5}
...
## figs4 - comparison of lowest and highest dosages of waterbourne exposure to rotenone
```{r, fig.width=8, fig.height=5}
# Pivot the data set to a longer format, separating out the dosage type (lowest or highest) and value into separate columns
...
## figs5 - comparison of lowest and highest dosages of waterbourne exposure atrazine
...
## figs6 - comparison to lowest and highest dosages of waterbourne exposure to glyphosate
```{r, fig.width=8, fig.height=5}
# Pivot the data set to a longer format, separating out the dosage type (lowest or highest) and value into separate columns
...
## figs7  - comparison to lowest and highest dosages of waterbourne exposure to chlopyrifo
```{r, fig.width=8, fig.height=5}
# Pivot the data set to a longer format, separating out the dosage type (lowest or highest) and value into separate columns
...
## fig5c - durations of waterbourne exposure 
...
fig5c <- ggplot(pdo, aes(x = route , y = log(duration))) + 
    # Add a violin plot 
  geom_violin(fill = "#5F85AE", alpha =0.2, color = NA, trim = FALSE) +
  ...
  theme(panel.grid.major.y = element_blank(),
    ...
    axis.ticks.y = element_blank(),
    axis.text.x = element_text(size = 20),
    axis.text.y = element_text(size = 20, angle = 90, hjust = 0.45),
    axis.title.x = element_text(size = 20),
    axis.title.y = element_text(size = 20),
    plot.title = element_blank()) +
    coord_flip()
...
fig5c
# ggsave(here("figures", "fig5c_pesticide_duration_exposure.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig5c_pesticide_duration_exposure.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)

```

## fig5d - distribution of sample sizes 
```{r, fig.width=8, fig.height=5}
...
# Combine three plots into a single plot using a grid layout
fig5 <- ((fig5b | fig5c) / (fig5a | fig5d)  + plot_annotation(tag_levels = "A"))

fig5
# ggsave(here("figures", "fig5_pesticide_characteristics.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi = 800)
# ggsave(here("figures", "fig5_pesticide_characteristics.jpg"), width = 20, height = 12, units = "cm", scale = 2, dpi = 800)
...
ggsave(here("figures", "figs29_country_collaboration_with_self_citation.jpg"), width = 16, height = 10, units = "cm", scale = 2, dpi =800)
ggsave(here("figures", "figs29_country_collaboration_with_self_citation.pdf"), width = 16, height = 10, units = "cm", scale = 2, dpi =800)
