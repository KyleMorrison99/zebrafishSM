...
fig3b <- ggplot(target_class_pct, aes(reorder(pesticide_target_class, n), y = percentage)) +
 ...
 fig3b
# ggsave(here("figures", "fig3b_pesticide_target_count_test.png"), width = 16, height = 10, units = "cm", scale = 2, dpi = 300)
```
...
figs27 <- fullmap %>% 
  ...
  theme(legend.position="none") +
  scale_fill_gradient(low = "#5FAD78", high = "#975FAD", # set color gradient
                    name = "Score", na.value = "gray50",
                    limits = c(0.1, 24),
                    guide = guide_colorbar(direction = "vertical.")) +
                    guides(fill = guide_colourbar(barwidth = unit(15, units = "mm"), 
                    barheight = unit(50, units = "mm"))) # set legend size
