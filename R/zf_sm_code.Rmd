...
```{r comaprison of highest and lowest waterbourne exposure across all pesticides}
pdo <- pdo %>%
...
pdo_waterbourne <- pdo %>%
  ...
  filter(route == "waterbourne", dosage_unit_ugl == "ug/L") %>% 
...
```{r comparison of lowest and highest dosages}
