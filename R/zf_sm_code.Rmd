...
## Figure s3 - Plot showing the distributions of highest and lowest dosages of waterbourne exposure to deltamethrin
```{r, fig.width=8, fig.height=5}
...
## Figure s4 - Plot showing the distributions of highest and lowest dosages of waterbourne exposure to rotenone
```{r, fig.width=8, fig.height=5}
# Pivot the data set to a longer format, separating out the dosage type (lowest or highest) and value into separate columns
...
## Figure s5 - Plot showing the distributions of highest and lowest dosages of waterbourne exposure to atrazine
...
## Figure s6 - Plot showing the distributions of highest and lowest dosages of waterbourne exposure to glyphosate
```{r, fig.width=8, fig.height=5}
# Pivot the data set to a longer format, separating out the dosage type (lowest or highest) and value into separate columns
...
## Figure s7 - Plot showing the distributions of highest and lowest dosages of waterbourne exposure to chlopyrifo
```{r, fig.width=8, fig.height=5}
# Pivot the data set to a longer format, separating out the dosage type (lowest or highest) and value into separate columns
...
## fig6 - total number of studies investigating each broad behaviour class
```{r, fig.width=8, fig.height=5}
# Calculate total count for each category
...
## figs8 - total percentage of evaluated behaviours that were under the locomotion/ activity category
```{r, fig.width=8, fig.height=5}
...
## figs9 - total percentage of evaluated behaviours that were under the aggression category.
...
## figs10 - total percentage of evaluated behaviours that were under the social category.
```{r, fig.width=12, fig.height=5}
...
## figs11 - total percentage of evaluated behaviours that were under the foraging category.
```{r, fig.width=12, fig.height=5}
...
## figs12 - total percentage of evaluated behaviours that were under the antipredator category.
```{r, fig.width=12, fig.height=5}
...
## figs13 - total percentage of evaluated behaviours that were under the anxiety/boldness category.
```{r, fig.width=12, fig.height=5}
...
## figs14 - heat map to show which behavours have been investigated in which pesticide target class
...
## figs15 - heat map to show which behavours have been investigated in which pesticide chemical class
```{r, fig.width=16, fig.height=8}
...
## figs16 - heat map to show which life stages of exposure have been exposed to each pesticide chemical class
```{r, fig.width=16, fig.height=8}
...
## figs17 - heat map to show which life stages of exposure have been exposed to each target chemical class
```{r, fig.width=16, fig.height=8}
...
## fig s28 - thematic map based on keywords
```{r, fig.width=8, fig.height=5}
...
## figs28 - country collaborate network circle plot with self-collaborations included 
```{r, fig.width=8, fig.height=5}
...
## figs30 - country collaborate network circle plot with self-collaborations removed 
```{r, fig.width=8, fig.height=5}
...
## figs31 - continent collaborate network circle plot with self-collaborations included 
```{r, fig.width=8, fig.height=5}
...
## fig8 - continent collaborate network circle plot with self-collaborations removed 
```{r}
