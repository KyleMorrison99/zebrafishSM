...
```{r}
fig2 <- ((fig2a | fig2b) /(fig2c | fig2d)  + plot_annotation(tag_levels = "A"))
fig2
```
...
fig7 <- ggplot(fd_summary, aes(x = pesticide_target_class, y = behavioural_class, fill = count)) +
...
# Create a heatmap using ggplot2
fig8 <- ggplot(fd_summary_top5, aes(x = pesticide_chemical_class, y = behavioural_class, fill = count)) +
  geom_tile(color = "white") +
  scale_fill_gradient(low = "#BFEFFF", high = "#0047AB") +
...
fig9 <- ggplot(fd_summary_top5, aes(x = pesticide_chemical_class, y = life_stage_exposure, fill = count)) +
  geom_tile(color = "white") +
  scale_fill_gradient(low = "#BFEFFF", high = "#0047AB") +
...
```{r}
fig10 <- ((fig7 | fig8) /(fig9)   + plot_annotation(tag_levels = "A"))
